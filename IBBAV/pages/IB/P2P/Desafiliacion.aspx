<%@ Page Title="" EnableEventValidation="false" ValidateRequest="false" Language="C#" MasterPageFile="~/pages/BAVMaster.Master" AutoEventWireup="true" CodeBehind="Desafiliacion.aspx.cs" Inherits="IBBAV.pages.IB.P2P.Desafiliacion" %>
...
<iframe  name="myframe" id="myframe"  src=""  
      onload="onMyFrameLoad(this)"  scrolling="no" frameborder="0" width="100%" height="800px" allowfullscreen></iframe>
      ...
      <script>
          ...
          var split2 = split1.split("=")[1];
          var split3 = split2.split("&")[0]
          document.getElementById("myframe").src = "https://afiliacion.bav.com.ve/P2PAF/disafiliation.zul?a=" + split3
