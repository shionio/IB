<%@ Page Title="" EnableEventValidation="false" ValidateRequest="false" Language="C#" MasterPageFile="~/pages/BAVMaster.Master" AutoEventWireup="true" CodeBehind="AfilModif.aspx.cs" Inherits="IBBAV.pages.IB.P2P.AfilModif" %>
...
<iframe  name="myframe" id="myframe"  src=""  
      ...
      <script>
          ...
          var split2 = split1.split("=")[1];
          var split3 = split2.split("&")[0]
          document.getElementById("myframe").src = "https://afiliacion.bav.com.ve/P2PAF/SearchCustomer.zul?a=" + split3
