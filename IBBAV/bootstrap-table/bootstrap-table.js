...
!function ($) {
    ...
    BootstrapTable.prototype.initServer = function (silent, query) {
        ...
        $.ajax($.extend({}, calculateObjectValue(null, this.options.ajaxOptions), {
            ...
            data: this.options.contentType === 'application/json' && this.options.method === 'post' ?
                JSON.stringify(this.options.query[0]) : this.options.query[0],
            cache: this.options.cache,
            contentType: "application/json; charset=utf-8",//this.options.contentType,
    ...
    BootstrapTable.prototype.resetView = function (params) {
        ...
        if (this.options.height) {
            ...
            $tableContainer.css('min-height', '30px');
    ...
    BootstrapTable.prototype.refresh = function (params) {
        ...
        this.options.query = params.query;
